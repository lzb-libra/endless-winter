<template>
    <div style="padding: 0 15px;">
        <n-flex>
            <n-card v-for="(obj, index) in allHeroDatum" :key="index" :title="renderCardTitle(obj)" :hoverable="true" :embedded="true"
                ...
                <di style="display: flex;">
                    <n-card title="探险" size="small" :bordered="false">
                        ...
                        <div class="hero-skill-item" v-if="showModalInfo.skill.tx_1">
                            <div :class="renderSkillClass(1, 1)" :style="{ backgroundImage: `url(${renderTxImg()})` }">
                            </div>
                        ...
                        <div class="hero-skill-item" v-if="showModalInfo.skill.tx_2">
                            <div :class="renderSkillClass(2, 1)" :style="{ backgroundImage: `url(${renderTxImg()})` }">
                            </div>
                            <div style="flex: 1; padding-left: 10px;">
                        ...
                        <div class="hero-skill-item" v-if="showModalInfo.skill.tx_3">
                            <div :class="renderSkillClass(3, 1)" :style="{ backgroundImage: `url(${renderTxImg()})` }">
                            </div>
                            <div style="flex: 1; padding-left: 10px;">
                    ...
                    <n-card title="远征" size="small" :bordered="false">
                        <div style="height: 80px;">
                            <div>{{ `${showModalInfo.as === 1 ? '盾' : showModalInfo.as === 2 ? '矛' : '弓'}兵攻击力:
                                +${showModalInfo.skill.data[3] || 0}%` }}</div>
                            <div>{{ `${showModalInfo.as === 1 ? '盾' : showModalInfo.as === 2 ? '矛' : '弓'}兵防御力:
                                +${showModalInfo.skill.data[4] || 0}%` }} </div>
                        </div>
                        <div class="hero-skill-item" v-if="showModalInfo.skill.yz_1">
                            <div :class="renderSkillClass(1, 2)" :style="{ backgroundImage: `url(${renderYzImg()})` }">
                            </div>
                            <div style="flex: 1; padding-left: 10px;">
                        ...
                        <div class="hero-skill-item" v-if="showModalInfo.skill.yz_2">
                            <div :class="renderSkillClass(2, 2)" :style="{ backgroundImage: `url(${renderYzImg()})` }">
                            </div>
                            <div style="flex: 1; padding-left: 10px;">
                        ...
                        <div class="hero-skill-item" v-if="showModalInfo.skill.yz_3">
                            <div :class="renderSkillClass(3, 2)" :style="{ backgroundImage: `url(${renderYzImg()})` }">
                            </div>
                            <div style="flex: 1; padding-left: 10px;">
...
const allHeroDatum = [
    {
        level: 'rare', name: '史密斯', addr: 'rare/ShiMiSi', width: '200', height: '250', as: 1, type: 2,
        story: [],
    ...
    {
        level: 'rare', name: '尤金', addr: 'rare/YouJin', width: '200', height: '250', as: 1, type: 3,
        story: [],
        source: ['英雄招募', '灯塔情报', '探险战斗', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'rare', name: '查理', addr: 'rare/ChaLi', width: '200', height: '250', as: 2, type: 3,
        story: [],
        source: ['英雄招募', '灯塔情报', '探险战斗', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'rare', name: '克劳瑞斯', addr: 'rare/KeLaoRuiSi', width: '200', height: '250', as: 3, type: 2,
        story: [],
        source: ['英雄招募', '灯塔情报', '探险战斗', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '谢尔盖', addr: 'epic/XieErGai', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: ['英雄招募', '灯塔情报', '探险战斗', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '帕特里克', addr: 'epic/PaTeLiKe', width: '200', height: '250', as: 2, type: 1,
        story: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '凌雪', addr: 'epic/LingXue', width: '200', height: '250', as: 2, type: 2,
        story: [],
        source: ['英雄招募', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '卢姆·波根', addr: 'epic/LuMuBoGen', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: ['英雄招募', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '杰西', addr: 'epic/JieXi', width: '200', height: '250', as: 2, type: 1,
        story: [],
    ...
    {
        level: 'epic', name: '巴希提', addr: 'epic/BaXiTi', width: '200', height: '250', as: 3, type: 1,
        story: [],
    ...
    {
        level: 'epic', name: '杰塞尔', addr: 'epic/JieSaiEr', width: '200', height: '250', as: 3, type: 2,
        story: [],
        source: ['英雄招募', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '吉娜', addr: 'epic/JiNa', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: ['吉娜的复仇', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'epic', name: '书允', addr: 'epic/ShuYun', width: '200', height: '250', as: 3, type: 2,
        story: [],
        source: ['英雄招募', '通用碎片兑换'],
        skill: {
            data: ["", "", "", "", ""],
    ...
    {
        level: 'S1', name: '赫罗尼莫', addr: 'lore/S1/HeLuoNiMo', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: ['统帅礼包购买'],
        talent: {
            name: '天生领袖',
    ...
    {
        level: 'S1', name: '娜塔莉娅', addr: 'lore/S1/NaTaLiYa', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        talent: {
            name: '白熊之力',
    ...
    {
        level: 'S1', name: '茉莉', addr: 'lore/S1/MoLi', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S1', name: '津曼', addr: 'lore/S1/JingMan', width: '200', height: '250', as: 3, type: 2,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S2', name: '弗林特', addr: 'lore/S2/FuLinTe', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S2', name: '菲兰德', addr: 'lore/S2/FeiLanDe', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S2', name: '阿索隆', addr: 'lore/S2/ASuoLong', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S3', name: '罗根', addr: 'lore/S3/LuoGen', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S3', name: '米娅', addr: 'lore/S3/MiYa', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S3', name: '格雷格', addr: 'lore/S3/GeLeiGe', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S4', name: '阿赫摩斯', addr: 'lore/S4/AHeMoSi', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S4', name: '玲奈', addr: 'lore/S4/LingNai', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S4', name: '琳恩', addr: 'lore/S4/LinEn', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S5', name: '赫克托', addr: 'lore/S5/HeKeTuo', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S5', name: '诺拉', addr: 'lore/S5/NuoLa', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S5', name: '格温', addr: 'lore/S5/GeWen', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S6', name: '无名', addr: 'lore/S6/WuMing', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S6', name: '芮妮', addr: 'lore/S6/RuiNi', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S6', name: '韦恩', addr: 'lore/S6/WeiEn', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S7', name: '艾迪丝', addr: 'lore/S7/AiDiSi', width: '200', height: '250', as: 1, type: 1,
        story: [],
    ...
    {
        level: 'S7', name: '哥顿', addr: 'lore/S7/GeDun', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S7', name: '布拉德利', addr: 'lore/S7/BuLaDeLi', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S8', name: '加托', addr: 'lore/S8/JiaTuo', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: ['英雄殿堂', '英雄招募'],
    ...
    {
        level: 'S8', name: '索尼娅', addr: 'lore/S8/SuoNiYa', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: ['英雄殿堂', '英雄招募'],
    ...
    {
        level: 'S8', name: '亨德里克', addr: 'lore/S8/HengDeLiKe', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: ['英雄殿堂', '英雄招募'],
    ...
    {
        level: 'S9', name: '马格努斯', addr: 'lore/S9/MaGeNuSi', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S9', name: '弗雷德', addr: 'lore/S9/FuLeiDe', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S9', name: '修拉', addr: 'lore/S9/XiuLa', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S10', name: '格里高利', addr: 'lore/S10/GeLiGaoLi', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S10', name: '芙蕾雅', addr: 'lore/S10/FuLeiYa', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S10', name: '布兰琪', addr: 'lore/S10/BuLanQi', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S11', name: '埃莱奥诺拉', addr: 'lore/S11/AiLaiAoNuoLa', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S11', name: '劳埃德', addr: 'lore/S11/LaoAiDe', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S11', name: '鲁弗斯', addr: 'lore/S11/LuFuSi', width: '200', height: '250', as: 3, type: 1,
        story: [],
        source: [],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S12', name: '赫尔薇尔', addr: 'lore/S12/HeErWeiEr', width: '200', height: '250', as: 1, type: 1,
        story: [],
    ...
    {
        level: 'S12', name: '加罗尔', addr: 'lore/S12/JiaLuoEr', width: '200', height: '250', as: 2, type: 1,
        story: [],
    ...
    {
        level: 'S12', name: '丽姬娅', addr: 'lore/S12/LiJiYa', width: '200', height: '250', as: 3, type: 1,
        story: [],
    ...
    {
        level: 'S13', name: '吉塞拉', addr: 'lore/S13/JiSaiLa', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: ['最强领主', '冻土之王', '最强王国', '每日特惠', '英雄集结', '兵工厂商店', '通用碎片兑换'],
        skill: {
            data: ['', '', '', '', ''],
    ...
    {
        level: 'S13', name: '弗洛拉', addr: 'lore/S13/FuLuoLa', width: '200', height: '250', as: 2, type: 1,
        story: [],
        source: ['兵工厂商店'],
    ...
    {
        level: 'S13', name: '乌尔卡努斯', addr: 'lore/S13/WuErKaNuSi', width: '200', height: '250', as: 1, type: 1,
        story: [],
        source: ['幸运大转盘', '兵工厂商店'],
...
const renderCardTitle = (obj) => {
    return h('div', {}, [
                h('span', { style: { paddingRight: '5px' } }, obj.name),
                h(NTag, { type: 'success' }, obj.level === 'rare' ? '稀有' : obj.level === 'epic' ? '史诗' : obj.level)
            ]);
}
...
const renderAvatar = (obj) => {
    const imgUrl = `../assets/heros/${obj.addr}/avatar.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderPortrait = (obj) => {
    const imgUrl = `../assets/heros/${obj.addr}/portrait.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderTalent = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/tf.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderTxImg = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/tx.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderYzImg = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/yz.png`
    console.log("renderYzImg: " + imgUrl)
    return new URL(imgUrl, import.meta.url).href;
}

const renderZwImg = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/zw.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderZwTxImg = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/zw-tx.png`
    return new URL(imgUrl, import.meta.url).href;
}

const renderZwYzImg = () => {
    const imgUrl = `../assets/heros/${showModalInfo.value.addr}/zw-yz.png`
    return new URL(imgUrl, import.meta.url).href;
}
